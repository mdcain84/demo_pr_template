...
const BRANCH_CONTRACT = /^(build|ci|docs|feat|fix|perf|refactor|style|test)\/JIRA-[0-9]{1,6}-|CESBASE-[0-9]{1,6}-/;
//const CODE_CONTRACT = /NGSD-[0-9]{1,6}-/;
...
function handleBadBranchName(){
  ...
  console.log('they must start with a type of "build", "ci", "docs", "feat", "fix", "perf", "refactor", "style", or "test",');
  console.log('followed by a "/" char and then a valid JIRA issue identifier, followed by a dash');
  ...
  console.log('git branch -m feature/NGSD-1201-some-killer-feature');
